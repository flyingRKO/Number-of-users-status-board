...
import com.rko.numberofusersstatusboard.service.EventService;
    ...
    void givenNothing_whenRequestingEvents_thenReturnsListOfEventsInStandardResponse() throws Exception {
        ...
        mvc.perform(
                get("/api/events")
                        ...
                        .queryParam("eventStartDatetime", "2023-01-01T00:00:00")
                        .queryParam("eventEndDatetime", "2023-01-01T00:00:00")
                )
                ...
                .andExpect(jsonPath("$.data[0].memo").value("마스크는 꼭 착용해주세요"))
    ...
    void givenEvent_whenCreatingAnEvent_thenReturnsSuccessfulStandardResponse() throws Exception {
        ...
        mvc.perform(
                        post("/api/events")
                                ...
                                .contentType(mapper.writeValueAsString(eventResponse))
                )
