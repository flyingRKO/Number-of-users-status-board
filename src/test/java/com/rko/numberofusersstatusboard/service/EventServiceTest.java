...
class EventServiceTest {
    ...
    @DisplayName("이벤트를 검색하는데 에러가 발생한 경우, 프로젝트 기본 에러로 전환하여 예외를 던진다.")
    @Test
    ...
    @Test
    void  givenEventId_whenSearchingExistingEvents_thenReturnsEvent() {
        // Given
        long eventId = 1L;
    ...
    void  givenNothing_whenCreating_thenAbortCreatingAndReturnsFalse() {
        // Given
        given(eventRepository.insertEvent(null)).willReturn(true);
    ...
    @DisplayName("이벤트 생성 중 데이터 예외가 발생하면, 프로젝트 기본 에러로 전환하여 예외를 던진다.")
    @Test
    ...
    @DisplayName("이벤트 ID를 주고 변경할 정보를 주지 않으면, 이벤트 정보 변경을 중단하고 결과를 false 로 보여준다.")
    @Test
    ...
    @DisplayName("이벤트 변경 중 데이터 오류가 발생하면, 프로젝트 기본 에러로 전환하여 예외를 던진다.")
    @Test
    ...
    @DisplayName("이벤트 삭제 중 데이터 오류가 발생하면, 프로젝트 기본 에러로 전환하여 예외를 던진다.")
    @Test
